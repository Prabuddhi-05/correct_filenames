...
Run this from the current directory that contains the bag folders.
"""
...
def ts_from_real(fname: str) -> float:
    """example - timestamp from real file '1731409262_076409304.png' or '.pcd'"""
...
def ts_from_json(fname: str) -> float:
    """example - timestamp from json entry '1731409262.076409.png'"""
